...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/duckdb-split-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/duckdb-split-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
Once the `conda-forge` channel has been enabled, `duckdb-cli, duckdb-extension-autocomplete, duckdb-extension-ducklake, duckdb-extension-fts, duckdb-extension-httpfs, duckdb-extension-json, duckdb-extension-spatial, duckdb-extension-tpcds, duckdb-extension-tpch, libduckdb, libduckdb-devel` can be installed with `conda`:
